...
public class GameRoomFrame {
   ...
   private void initialize() {
      ...
      frame.setBounds(100, 100, 523, 550);//523, 460);
      ...
      btnNewButton.setFont(new Font(" ؽ  ǲ      B", Font.PLAIN, 60));
      ...
      btnNewButton_1.setFont(new Font(" ؽ  ǲ      B", Font.PLAIN, 60));
